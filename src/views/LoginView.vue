...
.green-button {
  background-color: #2ca1a7 !important; /* Facebook blue color */
  color: white;
  padding: 10px 20px;
  border: none;
  border-radius: 4px;
...
.green-button:hover {
    background-color: rgb(252, 252, 253); /* Une teinte plus foncée de vert lors du survol */
}
